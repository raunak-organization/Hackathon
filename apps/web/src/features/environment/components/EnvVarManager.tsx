  ...
  return (
    <div className="mb-10">
      <div className="flex justify-between items-center mb-5">
        ...
        <button className="bg-(--text-primary) text-(--bg-primary) text-[0.85rem] font-medium px-4 py-2 rounded-md flex items-center gap-2 hover:bg-white transition-colors">
          <Plus size={14} />
          Add Variable
        </button>
      </div>
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr>
              ...
              <th className="text-right p-4 bg-(--bg-secondary) text-(--text-secondary) font-medium text-[0.85rem] border-b border-(--border)">
                Actions
              </th>
            </tr>
          </thead>
                ...
                >
                  ...
                  <td className="p-4 text-right">
                    <div className="flex items-center justify-end gap-3">
                      ...
                      <button className="text-(--accent-red) hover:bg-[rgba(239,68,68,0.1)] p-1 rounded transition-colors">
                        <Trash2 size={16} />
                      </button>
                    </div>
                  </td>
